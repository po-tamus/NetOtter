...
Enter \"new\" to create a new one (3 max): """)
            ...
            if command == "NEW":
                ...
                num = input("Enter your account number (1, 2, 3): ")
                pfp = input("Enter your new profile picture: ")
                print("\n")
                if num == 1:
                    self.profile = Profile(name, num, pfp)
                elif num == 2:
                    self.profile2 = Profile(name, num, pfp)
                elif num == 3: 
                    self.profile3 = Profile(name, num, pfp)
            elif command == "LOG":
                break
